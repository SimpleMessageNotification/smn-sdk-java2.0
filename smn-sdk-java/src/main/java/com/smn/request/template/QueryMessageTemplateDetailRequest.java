...
/**
 * the request of query message template
 *
 * @author zhangyx
 * @version 2.0.0
 */
public class QueryMessageTemplateDetailRequest extends AbstractRequest<QueryMessageTemplateDetailResponse> {
    ...
    public QueryMessageTemplateDetailRequest setMessageTemplateId(String messageTemplateId) {
