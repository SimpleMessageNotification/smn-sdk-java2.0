...
/**
 * the request of delete topic
 *
 * @author zhangyx
 * @version 2.0.0
 */
public class DeleteTopicRequest extends AbstractRequest<DeleteTopicResponse> {
    /**
    ...
    public DeleteTopicRequest setTopicUrn(String topicUrn) {
